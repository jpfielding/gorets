...
// <Listings
// xmlns="http://rets.org/xsd/Syndication/2012-03"
// xmlns:commons="http://rets.org/xsd/RETSCommons"
// xmlns:schemaLocation="http://rets.org/xsd/Syndication/2012-03/Syndication.xsd"
// xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
// listingsKey="2012-03-06T22:14:47"
// version="0.96"
// versionTimestamp="2012-02-07T03:00:00Z"
// xml:lang="en-us">
...
// OpenListings ...
func OpenListings(out io.ReadCloser, each EachListing) error {
	return nil
}
...
type Listing struct {
	...
	ListPrice            SecurePrice       `xml:"ListPrice"`
	ListPriceLow         SecurePrice       `xml:"ListPriceLow,omitempty"`
	AlternativePrices    AlternativePrices `xml:"AlternativePrices"`
	ListingURL           string
	ProviderName         string
	ProviderURL          string
	...
	PropertySubType      PropertyType `xml:"PropertySubType"`
	ListingKey           string
	...
	ThreeQuartBathrooms  string
	HalfBathrooms        string
	OneQuarterBathrooms  string
	ForeclosureStatus    string
}

// Address ...
type Address struct {
	Order             int    `xml:"commons:preference-order"`
	AddressOrder      int    `xml:"commons:address-preference-order"`
	FullStreetAddress string `xml:"commons:FullStreetAddress"`
	UnitNumber        string `xml:"commons:UnitNumber"`
	City              string `xml:"commons:City"`
	StateOrProvince   string `xml:"commons:StateOrProvince"`
	PostalCode        string `xml:"commons:PostalCode"`
	Country           string `xml:"commons:Country"`
}

// SecurePrice ...
type SecurePrice struct {
	SecurityClass string `xml:"isgSecurityClass,attr"`
	Value         int    `xml:",chardata"`
}

// AlternativePrices ...
type AlternativePrices struct {
	AlternativePrice []AlternativePrice `xml:"AlternativePrice"`
}

// AlternativePrice ...
type AlternativePrice struct {
	AlternativePrice    AlternativeListPrice `xml:"AlternativeListPrice"`
	AlternativePriceLow AlternativeListPrice `xml:"AlternativeListPriceLow,omitempty"`
}

// AlternativeListPrice ...
type AlternativeListPrice struct {
...
type MarketingInformation struct {
	PermitAddressOnInternet      SecureBoolean
	VOWAddressDisplay            SecureBoolean
	VOWAutomatedValuationDisplay SecureBoolean
	VOWConsumerComment           SecureBoolean
}

// SecureBoolean ...
type SecureBoolean struct {
	SecurityClass string `xml:"commons:isgSecurityClass,attr"`
...
// Photo ...
type Photo struct {
	MediaModificationTimestamp SecureDate
	MediaURL                   string
	MediaCaption               string
